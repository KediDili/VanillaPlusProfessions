        ...
        public static void ApplyPatches()
        {
            try
            {
                ModEntry.Harmony.Patch(
                    ...
                    transpiler: new HarmonyMethod(typeof(MiscPatcher), nameof(MiscPatcher.Transpiler_2))
                );
            }
            catch (Exception e)
            {
            ...
            try
            {
                ModEntry.Harmony.Patch(
                   ...
                   postfix: new HarmonyMethod(typeof(MiscPatcher), nameof(MiscPatcher.tryAddPrismaticButterfly))
               );
            }
            catch (Exception e)
            {
            ...
            try
            {
                ModEntry.Harmony.Patch(
                   ...
                   postfix: new HarmonyMethod(typeof(MiscPatcher), nameof(MiscPatcher.TryCreateBuffsFromData_Postfix))
               );
            }
            catch (Exception e)
            {
            ...
            try
            {
                ModEntry.Harmony.Patch(
                   ...
                   postfix: new HarmonyMethod(typeof(MiscPatcher), nameof(MiscPatcher.readNote))
               );
            }
            catch (Exception e)
            {
